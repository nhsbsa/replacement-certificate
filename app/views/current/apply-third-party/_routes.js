...
// What is the patient's nationality?
...
router.post(['/treatmentStart', '/treatmentStartErr','/treatmentStartDateErr', '/treatmentStartDayErr', '/treatmentStartDayMonthErr', '/treatmentStartDayYearErr','/treatmentStartMonthErr', '/treatmentStartMonthYearErr', '/treatmentStartYearErr', '/treatmentStartErr', '/treatmentStartFutureErr', '/treatmentStartInvalidErr'], function (req, res) {
  ...
  // if (treatmentStart == 'text' && isNumeric(chooseDay, chooseMonth, chooseYear) == true) {
  //   res.redirect('treatment-facility-name')
  // }
  // else if (hasNumber(treatmentStart) == true && isNumeric(chooseDay, chooseMonth, chooseYear) == false) {
  //   res.redirect('treatment-facility-name')
  // }
  // else if (treatmentStart == 'text' && isNumeric(chooseDay, chooseMonth, chooseYear) == false) {
  //   res.redirect('treatment-start-date-error')
  // } 
  // else {
  //   res.redirect('treatment-start-error')
...
router.post(['/data-capture/dateBirth', '/data-capture/dateBirthErr', '/data-capture/dateDayMonthErr', '/data-capture/dateYearErr'], function (req, res) {
  ...
  else if(isNumeric(birthDay, birthMonth, birthYear) == false) {
    res.redirect('dob-error')
  }
  else if(isNumeric(birthDay, birthMonth) == false && isNumeric(birthYear) == true) {
    res.redirect('dob-day-month-error')
  }
  else if(isNumeric(birthYear) == false && isNumeric(birthDay, birthMonth) == true) {
...
router.post(['/treatmentFacilityEmail', '/treatmentFacilityEmailErr'], function (req, res) {
...
router.post(['/data-capture/yourEmailAddress', '/data-capture/yourEmailAddressErr'], function (req, res) {
  var emailAddress = req.session.data['your-email-address']
  if (emailAddress == '') {
